...
do4 = interp1(time, data, t3:10800:last);

%do1 = interp1(time(si1), data(si1, :), 1:1440:t1);
%do2 = interp1(time(si2), data(si2, :), t1:360:t2);
%do3 = interp1(time(si3), data(si3, :), t2:360:t3);
%do4 = interp1(time(si4), data(si4, :), t2:10800:last);

timeo = [1:1440:t1, t1:360:t2, t2:360:t3, t3:10800:last];
